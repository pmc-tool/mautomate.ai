...
export default async function Footer() {
  const [categories, settings, activeTheme, brand] = await Promise.all([
  ...
  // The active theme MAY provide a bespoke footer (self-contained, resolves its
  // own data); otherwise render the Learts footer below.
  const ThemeFooter = activeTheme.Footer
  if (ThemeFooter) {
    return <ThemeFooter />
  }
