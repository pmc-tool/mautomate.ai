...
export async function listCollections(
  ...
  return {
    collections: [
      { id: "col_1", title: "Summer 2024", handle: "summer-2024", product_count: 12 },
      { id: "col_2", title: "New Arrivals", handle: "new-arrivals", product_count: 8 },
      { id: "col_3", title: "Sale", handle: "sale", product_count: 24 },
    ],
    count: 3,
  }
}
...
export async function createCollection(
  ...
  return {
    collection: {
      id: `col_${Date.now()}`,
      title: body.title,
      handle: body.handle || slugify(body.title),
      product_count: 0,
    },
  }
}
    ...
    regions: [
      {
        ...
        fulfillment_providers: [{ id: "manual", name: "Manual" }],
      },
      {
        id: "reg_2",
        name: "Europe",
