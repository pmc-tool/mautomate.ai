/* Helendo theme — block map. Every visual block has a bespoke Helendo
 * renderer built from the Helendo template markup; `container` is
...
export const helendoBlocks: ThemeBlockMap = {
