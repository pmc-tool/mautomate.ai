...
/* ------------------------------------------------------------------ */
/* Helendo renderer for the product_tabs CMS block ("Best Selling").    */
/*                                                                      */
...
/* `groups` to the pure ProductTabsView, which owns the Helendo markup.  */
/* Splitting the presentational half out lets the visual-editor canvas   */
/* render the IDENTICAL Helendo markup from client-fetched groups        */
