...
/* ------------------------------------------------------------------ */
/* Helendo renderer for the category_showcase CMS block.                */
/*                                                                      */
...
/* CategoryShowcaseView, which owns the Helendo markup. Splitting the    */
/* presentational half out lets the visual-editor canvas render the      */
/* IDENTICAL Helendo markup from client-fetched tiles (WYSIWYG parity).  */
