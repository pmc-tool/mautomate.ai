/* Rokon theme — block map. Every visual block has a bespoke Rokon renderer
 * built from the Rokon (Hook) template markup; `container` is theme-neutral
...
export const rokonBlocks: ThemeBlockMap = {
