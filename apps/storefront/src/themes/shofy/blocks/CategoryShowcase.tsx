...
/* ------------------------------------------------------------------ */
/* Shofy renderer for the category_showcase CMS block.                  */
/*                                                                      */
...
/* CategoryShowcaseView, which owns the Shofy .tp-product-category       */
/* markup. Splitting the presentational half out lets the visual-editor  */
/* canvas render the IDENTICAL Shofy markup from client-fetched tiles     */
/* (WYSIWYG parity). Tiles referencing a missing `category_id` are        */
/* dropped (dangling-ref safe); tiles WITHOUT a `category_id` are static  */
/* and always rendered.                                                  */
/* ------------------------------------------------------------------ */
