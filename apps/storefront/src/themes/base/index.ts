...
export const baseTheme: ThemeManifest = {
  id: "base",
  name: "Base",
  description:
  ...
  // No CMS block renderers: the React block path was deleted in Phase 2 of
  // the editor rebuild — every CMS page renders through the Liquid theme
  // engine (/theme-render). `base` exists only for the REACT_ONLY interactive
  // pages (account/checkout/order/payment/wishlist) and their chrome.
  blocks: {},
