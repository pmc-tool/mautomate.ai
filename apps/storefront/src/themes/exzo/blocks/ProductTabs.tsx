...
/* ------------------------------------------------------------------ */
/* Exzo renderer for the product_tabs CMS block (the index1.html        */
/* "something new for you" tabs-block).                                 */
/*                                                                      */
...
/* `groups` to the pure ProductTabsView, which owns the Exzo markup.     */
/* Splitting the presentational half out lets the visual-editor canvas   */
/* render the IDENTICAL Exzo markup from client-fetched groups           */
