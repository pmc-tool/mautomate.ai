...
/* ------------------------------------------------------------------ */
/* Exzo renderer for the category_showcase CMS block.                   */
/*                                                                      */
...
/* CategoryShowcaseView, which owns the Exzo markup. Splitting the       */
/* presentational half out lets the visual-editor canvas render the      */
/* IDENTICAL Exzo markup from client-fetched tiles (WYSIWYG parity).     */
