/* Exzo theme — block map. Every visual block has a bespoke Exzo renderer
 * built from the Exzo template markup; `container` is theme-neutral and
...
export const exzoBlocks: ThemeBlockMap = {
