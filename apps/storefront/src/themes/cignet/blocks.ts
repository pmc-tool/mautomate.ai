/* Cignet theme — block map. Every visual block has a bespoke Cignet renderer
 * built from the Cignet template markup; `container` is theme-neutral and
...
export const cignetBlocks: ThemeBlockMap = {
