...
/* ------------------------------------------------------------------ */
/* Cignet renderer for the product_tabs CMS block ("Our Products").     */
/*                                                                      */
...
/* `groups` to the pure ProductTabsView, which owns the Cignet markup.   */
/* Splitting the presentational half out lets the visual-editor canvas   */
/* render the IDENTICAL Cignet markup from client-fetched groups         */
...
/* (dangling-ref safe). `countryCode` resolves region-scoped prices; we  */
/* fall back to the default region when absent.                          */
/* ------------------------------------------------------------------ */
