...
/* ------------------------------------------------------------------ */
/* Cignet renderer for the category_showcase CMS block.                 */
/*                                                                      */
...
/* CategoryShowcaseView, which owns the Cignet markup. Splitting the     */
/* presentational half out lets the visual-editor canvas render the      */
/* IDENTICAL Cignet markup from client-fetched tiles (WYSIWYG parity).   */
