/* Bazaro theme — block map. Every visual block has a bespoke Bazaro renderer
 * built from the Bazaro template markup (aq-/aqf- classes); `container` is
 * theme-neutral and shared across themes. */
...
export const bazaroBlocks: ThemeBlockMap = {
