...
/* ------------------------------------------------------------------ */
/* Bazaro renderer for the category_showcase CMS block                  */
/* (`aqf-collection-area` "Season Collection").                         */
/*                                                                      */
...
/* CategoryShowcaseView, which owns the Bazaro markup. Splitting the     */
/* presentational half out lets the visual-editor canvas render the      */
/* IDENTICAL Bazaro markup from client-fetched tiles (WYSIWYG parity).   */
