...
/* ------------------------------------------------------------------ */
/* Bazaro renderer for the product_tabs CMS block (template             */
/* `aq-product-area`).                                                  */
/*                                                                      */
...
/* `groups` to the pure ProductTabsView, which owns the Bazaro markup.   */
/* Splitting the presentational half out lets the visual-editor canvas   */
/* render the IDENTICAL Bazaro markup from client-fetched groups         */
