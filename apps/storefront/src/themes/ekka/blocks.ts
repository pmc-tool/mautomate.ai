/* Ekka theme — block map. Every visual block has a bespoke Ekka renderer
 * built from the Ekka template markup; `container` is theme-neutral and
...
export const ekkaBlocks: ThemeBlockMap = {
