...
/* ------------------------------------------------------------------ */
/* Ekka renderer for the product_tabs CMS block ("Our Top Collection"). */
/*                                                                      */
...
/* `groups` to the pure ProductTabsView, which owns the Ekka markup.     */
/* Splitting the presentational half out lets the visual-editor canvas   */
/* render the IDENTICAL Ekka markup from client-fetched groups           */
