    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <button
          ...
          const rootDomain = typeof window !== "undefined" ? window.location.host.replace(/^merchant\./, "") : "mautomate.ai"
          const storeHost = me?.store?.domain || (me?.store?.slug ? `${me.store.slug}.${rootDomain}` : window.location.host)
          const editorOrigin = `https://${storeHost}`
          const redirectUrl =
