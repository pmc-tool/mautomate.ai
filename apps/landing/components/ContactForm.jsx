...
// The interactive contact form. Split out of app/contact/page.jsx so that page
// can be a server component and export real per-page metadata (title, canonical)
// — a client component ("use client") cannot export metadata.
